						...
						<thead>
							<tr>
								...
								<td style="text-align: right;">
									<a class="headinga2" href="<?=$order["ORDER"]["URL_TO_DETAIL"]?>"><?=GetMessage('SPOL_ORDER_DETAIL')?></a>
<?/*=======
							...
							<tr>
								...
								<td class="bx_my_order_table_manag">
                                    ...
                                    <div class="bx_my_order_butts">
                                        <a href="<?=$order["ORDER"]["URL_TO_COPY"]?>" style="min-width:120px"class="bx_big bx_bt_button_type_2 bx_cart bx_order_action"><?=GetMessage('SPOL_REPEAT_ORDER')?></a>
                                        <?if($order["ORDER"]["CANCELED"] != "Y"):?>
                                            <a href="<?=$order["ORDER"]["URL_TO_CANCEL"]?>" style="min-width:120px; margin-left:25px;" class="bx_big bx_bt_button_type_2 bx_cart bx_order_action"><?=GetMessage('SPOL_CANCEL_ORDER')?></a>
                                        <?endif?>
                                    </div>
<?/*=======
								<td>
...
>>>>>>> origin/deploy */?>
	...
	<?else:?>
		<font style="color:#B41A26; padding-bottom: 45px; font-size:22pt;"><?=GetMessage('SPOL_NO_ORDERS')?></font>
<?/*=======
