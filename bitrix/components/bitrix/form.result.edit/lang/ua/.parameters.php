...
$MESS["FORM_COMP_VALUE_NO"] = "Ні";
$MESS["COMP_FORM_GROUP_PARAMS"] = "Параметри компонента";
$MESS["COMP_FORM_PARAMS_CHAIN_ITEM_LINK"] = "Посилання на додатковому пункті у навігаційному ланцюжку";
$MESS["COMP_FORM_PARAMS_VIEW_URL"] = "Сторінка перегляду результату";
$MESS["COMP_FORM_PARAMS_LIST_URL"] = "Сторінка зі списком результатів";
$MESS["COMP_FORM_SEF_RESULT_EDIT_PAGE"] = "Шаблон URL сторінки редагування";
$MESS["COMP_FORM_NAME_TEMPLATE"] = "Формат імені";
?>