...
$MESS ['CITY_OUT_LOCATION_TIP'] = "If checked, the handler will return the location ID.";
$MESS ['ONCITYCHANGE_TIP'] = "Specifies the name of the <b>city selection</b> event handler.";
?>