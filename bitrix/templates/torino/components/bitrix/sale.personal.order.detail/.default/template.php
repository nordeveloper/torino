...
<div class="bx_my_order_switch">
    <h4><a class="bx_mo_link" href="<?=$arResult["URL_TO_LIST"]?>">
        Вернуться к списку заказов
        <?//=GetMessage('SPOD_CUR_ORDERS')?>
	</a></h4>
</div>
...
<div class="bx_order_list">
	...
	<?else:?>
		...
		<table class="bx_order_list_table table-responsive">
			<thead>
				<tr>
					<td colspan="2">
        ...
        <br />
		<table class="bx_order_list_table_order table-responsive">
			<thead>
				<tr>			
        ...
        <br /><h3 class="text-center">Детальная информация о заказе</h3><br />
        <table class="bx_order_list_table table-responsive">
            <thead>
            <tr>
                <td colspan="2">
		...
		<br/><br/>
        <h4><a href="<?=$arResult["URL_TO_LIST"]?>" class="btn btn-lg btn-primary">
