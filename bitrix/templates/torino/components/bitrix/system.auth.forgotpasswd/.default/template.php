<div class="fullwidth">
    <div class="centered"><div class="bx-auth wrkdiv" id="registrationpanel">
        ...
        <table class="data-table bx-forgotpass-table">
            ...
            <tfoot>
                <tr>
                    <td colspan="2">
                        <input type="submit" style="padding: 4px 68px; margin-left:62px;" class="systhref-submit" name="send_account_info" value="<?=GetMessage("AUTH_SEND")?>" />
                    </td>
                </tr>
            </tfoot>
        </table>
