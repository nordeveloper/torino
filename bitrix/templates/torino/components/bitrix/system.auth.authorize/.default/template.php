...
<?if($arParams["NOT_SHOW_LINKS"] != "Y" && $arResult["NEW_USER_REGISTRATION"] == "Y" && $arParams["AUTHORIZE_REGISTRATION"] != "Y"):?>
		<noindex>
			<p>
                Если вы впервые на сайте, заполните, пожалуйста, <a href="<?=$arResult["AUTH_REGISTER_URL"]?>" rel="nofollow"><strong>регистрационную форму</strong></a>.<br />
			</p>
		</noindex>
<?endif?>
...
<?if ($arParams["NOT_SHOW_LINKS"] != "Y"):?>
    <noindex>
        <p>
            <a href="<?=$arResult["AUTH_FORGOT_PASSWORD_URL"]?>" rel="nofollow"><strong><?=GetMessage("AUTH_FORGOT_PASSWORD_2")?></strong></a>
            <br/><br/><br/>
        </p>
    </noindex>
<?endif?>
