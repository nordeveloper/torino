...
<div class="col-lg-10 col-md-10 col-sm-8 col-xs-12 <?//bx_catalog_list_home?>">
    <?/*id="catalogItems3" col<? echo $arParams['LINE_ELEMENT_COUNT']; ?> <? echo $templateData['TEMPLATE_CLASS']; */?>
...
<?// echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>">
	...
	{
		?><a id="<? echo $arItemIDs['SECOND_PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="bx_catalog_item_images_double bx_catitem_images2" style="background-image: url('<? echo (
