                    ...
                    <div class="pricer table-responsive">
                        <div class="bx_catalog_item_controls">
                            ...
                            <div id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>" class="bx_catalog_item_controls_blocktwo text-center">
                                ...
                                <a class="bx_medium btn btn-darkredbutton addtocart" role="button" id="<? echo $arItemIDs['BUY_LINK']; ?>"  href="javascript:void(0)" rel="nofollow" data-item-id="<? echo $arItem['ID'] ?>">
