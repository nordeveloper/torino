...
?>
<div class="row cattophead">
    <h1
        class="<?echo $arCurView['TITLE']; ?> supersechead text-right"
        id="<? echo $this->GetEditAreaId($arResult['SECTION']['ID']); ?>">
            <?/*<a href="<? echo $arResult['SECTION']['SECTION_PAGE_URL']; ?>"></a>*/?>
            <?echo (
...
<div class="col-lg-2 col-md-2 col-sm-4 col-xs-12 catleftlist">

    <div class="<? echo $arCurView['CONT']; ?> <?=$arResult["SECTIONS_COUNT"]?>"><?
        ...
        <?switch ($arParams['VIEW_MODE'])
        {
            ...
            case 'TEXT':
                foreach ($arResult['SECTIONS'] as &$arSection)
                {
                    ...
                    if ($arParams["COUNT_ELEMENTS"])
                    {
                        ?> <span class="vertsplice">&nbsp;|</span><span>&nbsp;(<? echo $arSection['ELEMENT_CNT']; ?>)</span><?
                    }
                    ?></h2></li><?
                }
                unset($arSection);
