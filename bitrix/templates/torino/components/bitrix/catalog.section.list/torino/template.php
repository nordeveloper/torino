...
{
?>
<ul class="<? echo $arCurView['LIST']; ?> container">
<?
	switch ($arParams['VIEW_MODE'])
	{
		case 'LINE':
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				?><li class="col-lg-4 col-md-4 col-sm-6 col-xs-12" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
...
<div class="row">
    <h3 class="col-md-12 text-center">
        Пожалуйста, выберите категорию блюда, которое вы хотели бы заказать!
    </h3>
</div>
