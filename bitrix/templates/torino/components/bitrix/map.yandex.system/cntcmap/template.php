...
<div id="BX_YMAP_<?echo $arParams['MAP_ID']?>" class="bx-yandex-map mapdiv" style="height: <?echo $arParams['MAP_HEIGHT'];?>; width: <?echo $arParams['MAP_WIDTH']?>;">
	<?echo GetMessage('MYS_LOADING'.($arParams['WAIT_FOR_EVENT'] ? '_WAIT' : ''));?>
</div>