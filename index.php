    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 hidden-xs text-left">
        <h2 class="sechead">
            <?$APPLICATION->IncludeComponent(
                ...
                array(
                    "AREA_FILE_SHOW" => "file",
                    "PATH" => SITE_DIR."included/pizzashead.php",
                    "EDIT_TEMPLATE" => "",
...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 hidden-xs text-left">
        <h2 class="sechead">
            <?$APPLICATION->IncludeComponent(
                ...
                array(
                    "AREA_FILE_SHOW" => "file",
                    "PATH" => SITE_DIR."included/susihead.php",
                    "EDIT_TEMPLATE" => "",
                    "COMPONENT_TEMPLATE" => ".default"
                ),
                false
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        <h3 class="sechead text-uppercase">
            <a href="/catalog/sushi-rolly/">
                <?$APPLICATION->IncludeComponent(
                    "bitrix:main.include",
                    ".default",
                    array(
                        "AREA_FILE_SHOW" => "file",
                        "PATH" => SITE_DIR."included/allsusis.php",
                        "EDIT_TEMPLATE" => "",
                        "COMPONENT_TEMPLATE" => ".default"
                    ),
                    false
...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 hidden-xs text-left">
        <h2 class="sechead">
            <?$APPLICATION->IncludeComponent(
                ...
                array(
                    "AREA_FILE_SHOW" => "file",
                    "PATH" => SITE_DIR."included/saladshead.php",
                    "EDIT_TEMPLATE" => "",
                    "COMPONENT_TEMPLATE" => ".default"
                ),
                false
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        <h3 class="sechead text-uppercase">
            <a href="/catalog/salads/">
                <?$APPLICATION->IncludeComponent(
                    "bitrix:main.include",
                    ".default",
                    array(
                        "AREA_FILE_SHOW" => "file",
                        "PATH" => SITE_DIR."included/allsalads.php",
                        "EDIT_TEMPLATE" => "",
                        "COMPONENT_TEMPLATE" => ".default"
                    ),
                    false
